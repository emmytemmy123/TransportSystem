...
public class MailServiceImpl implements MailService {
	...
	@Override
	public void sendVerificationToken(String token, MailUser user) {
	...
	@Override
	public void resetPasswordToken(String token, MailUser user) {
	...
	private void sendHtmlEmail(String subject, String msg, MailUser user) {
		Map<String, Object> model = new HashMap<String, Object>();
	...
	private void sendHtmlMail(String from, String to, String subject, String body, boolean attachImage) throws MessagingException {
		...
		if (attachImage) {
			// Inline image
			helper.addInline("logo1.png", new ClassPathResource("logo1.png"));
			// attachment
			helper.addAttachment("logo.jpg", new ClassPathResource("logo.jpg"));
		}

		mailSender.send(mail);
		logger.info("Sent mail: {1}", subject);
	}
}
