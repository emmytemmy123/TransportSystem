...
import transport.management.repo.user.SellerRepository;
import transport.management.repo.user.UserRepository;
import transport.management.utills.EmailUtils;
...
public class SellerServiceImpl implements SellerService {
     ...
     * * */
    public ApiResponse<String> addSeller(@RequestBody SellerRequest request) {
    ...
    private Sellers getSellerFromRequest(SellerRequest request){
        ...
        sellers.setRoles(request.getRole());
