package logistic.management.repo.products;
...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    @Query("select st from Product st where st.productCategory.uuid=:recordId")
    List<Product> findByProductCategoryUuid(@Param("recordId") UUID productCategoryUuid);
